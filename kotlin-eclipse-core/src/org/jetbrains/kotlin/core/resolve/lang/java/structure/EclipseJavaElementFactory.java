...
public class EclipseJavaElementFactory {
    ...
    @NotNull
    public static Collection<JavaAnnotation> annotations(@NotNull IAnnotationBinding[] annotations) {
        return convert(annotations, Factories.ANNOTATIONS);
    }
    
    @NotNull
    public static Collection<JavaClassifierType> classifierTypes(@NotNull ITypeBinding[] classTypes) {
        return convert(classTypes, Factories.CLASSIFIER_TYPES);
    }
    
    @NotNull
    public static Collection<JavaMethod> methods(@NotNull IMethodBinding[] methods) {
        return convert(methods, Factories.METHODS);
    }
    
    @NotNull
    public static Collection<JavaField> fields(@NotNull IVariableBinding[] variables) {
