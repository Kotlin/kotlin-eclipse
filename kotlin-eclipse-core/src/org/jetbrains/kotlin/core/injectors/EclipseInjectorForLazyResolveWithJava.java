...
public class EclipseInjectorForLazyResolveWithJava {
    ...
    private final EclipseLazyResolveBasedCache eclipseLazyResolveBasedCache;
    ...
    public EclipseInjectorForLazyResolveWithJava(
        ...
        this.eclipseLazyResolveBasedCache = new EclipseLazyResolveBasedCache();
        ...
        this.globalJavaResolverContext = new GlobalJavaResolverContext(storageManager, eclipseJavaClassFinder, virtualFileFinder, deserializedDescriptorResolver, eclipseExternalAnnotationResolver, traceBasedExternalSignatureResolver, traceBasedErrorReporter, eclipseMethodSignatureChecker, eclipseLazyResolveBasedCache, eclipseJavaPropertyInitializerEvaluator, eclipseJavaSourceElementFactory, moduleClassResolver);
        ...
        eclipseLazyResolveBasedCache.setSession(resolveSession);
