...
public class KotlinAutoIndentTest extends KotlinAutoIndentTestCase {
    ...
    @Test
    public void AfterClassNameBeforeFun() {
        doAutoTest();
    }
    ...
    @Test
    public void InExpressionsParentheses() {
        doAutoTest();
    }
    ...
    @Test
    public void InLabmdaAfterArrow() {
        doAutoTest();
    }
    
    @Test
    public void InLambdaAfterArrowWithSpaces() {
        doAutoTest();
    }
    ...
    @Test
    public void InLambdaInsideChainCallSameLineWithSpaces() {
        doAutoTest();
    }
