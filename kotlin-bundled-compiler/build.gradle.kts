...
val kotlinPluginUpdateId = project.findProperty("kotlinPluginUpdateId") as String? ?: "150176" // Kotlin Plugin 1.6.10 for Idea 2021.3

val kotlinCompilerVersion: String = project.findProperty("kotlinCompilerVersion") as String? ?: "1.6.10"
