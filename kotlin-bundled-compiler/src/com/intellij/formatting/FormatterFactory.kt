...
//    
//    override fun createChildWrap(parentWrap: Wrap, wrapType: WrapType, wrapFirstElement: Boolean): Wrap {
//        val result = WrapImpl(wrapType, wrapFirstElement);
//        result.registerParent(parentWrap as WrapImpl);
//        return result;
//    }
//    
//    override fun createWrap(type: WrapType, wrapFirstElement: Boolean): Wrap = WrapImpl(type, wrapFirstElement)
}