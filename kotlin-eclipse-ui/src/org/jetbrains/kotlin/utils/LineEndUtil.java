...
public class LineEndUtil {
    ...
    public static final String CARRIAGE_RETURN_STRING = StringUtil.createStringFromChar(CARRIAGE_RETURN_CHAR);
    public static final char NEW_LINE_CHAR = '\n';
    public static final String NEW_LINE_STRING = StringUtil.createStringFromChar(NEW_LINE_CHAR);
