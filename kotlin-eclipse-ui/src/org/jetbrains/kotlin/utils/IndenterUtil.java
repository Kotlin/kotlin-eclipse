...
public class IndenterUtil {
    ...
    public static final String SPACE_STRING = StringUtil.createStringFromChar(SPACE_CHAR);
    public static final char TAB_CHAR = '\t';
    public static final String TAB_STRING = StringUtil.createStringFromChar(TAB_CHAR);
