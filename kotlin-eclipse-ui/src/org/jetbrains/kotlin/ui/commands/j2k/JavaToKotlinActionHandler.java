...
public class JavaToKotlinActionHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (selection instanceof IStructuredSelection) {
            ...
            if (result.getFirst().isOK()) {
                ...
                CommandsPackage.openAnyEditor(result.getSecond());
            } else {
    ...
    private Pair<IStatus, List<IFile>> convertToKotlin(@NotNull Set<CompilationUnit> compilationUnits, @NotNull Shell shell) {
        ...
        try {
            ...
            for (CompilationUnit compilationUnit : compilationUnits) {
                Pair<IFile, String> convertedFile = getConvertedFileCreationOperation(compilationUnit, shell);
                compositeOperation.add(new CreateFileOperation(convertedFile.getFirst(), null, 
                        new ByteArrayInputStream(convertedFile.getSecond().getBytes()), "Create Kotlin File"));
                
                convertedFiles.add(convertedFile.getFirst());
            }
    ...
    private Pair<IFile,String> getConvertedFileCreationOperation(@NotNull CompilationUnit compilationUnit, @NotNull Shell shell) throws ExecutionException {
        ...
        return new Pair<IFile, String>(file, formattedCode);
    }
