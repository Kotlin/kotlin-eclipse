...
public abstract class KotlinOverrideImplementMethodsProposal : KotlinQuickAssistProposal() {
    ...
    abstract fun collectMethodsToGenerate(classOrObject: JetClassOrObject): Set<CallableMemberDescriptor>
	...
	protected fun JetElement.resolveToDescriptor(): DeclarationDescriptor {
