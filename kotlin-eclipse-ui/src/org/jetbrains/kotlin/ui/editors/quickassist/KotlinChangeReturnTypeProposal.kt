...
class KotlinChangeReturnTypeProposal : KotlinQuickAssistProposal() {
    ...
    override fun isApplicable(psiElement: PsiElement): Boolean {
        ...
        if (expressionType == null || expectedType == null) return false
        ...
        if (ktFunction is KtFunction && KotlinQuickFixUtil.canFunctionOrGetterReturnExpression(ktFunction, expression)) {
        ...
        if (expression is KtCallExpression) {
            ...
            if (resolvedCall != null) {
                val functionDeclaration = if (ktFunction is KtFunction) ktFunction else null
