...
import org.jetbrains.kotlin.utils.IdeDescriptorRenderer;
...
public class KotlinSpecifyTypeAssistProposal extends KotlinQuickAssistProposal {
    ...
    private void addTypeAnnotationToElement(@NotNull IDocument document, @NotNull PsiElement anchor, @NotNull JetType exprType) {
        ...
        try {
            document.replace(getEndOffset(anchor, editor), 0, ": " + IdeDescriptorRenderer.SOURCE_CODE_SHORT_NAMES_IN_TYPES.renderType(exprType)); 
    ...
    private static boolean hasPublicMemberDiagnostic(@NotNull JetNamedDeclaration declaration) {
        ...
        BindingContext bindingContext = KotlinAnalyzer
                .analyzeOneFileCompletely(javaProject, declaration.getContainingFile())
                .getBindingContext();
