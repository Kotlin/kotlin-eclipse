...
fun getScriptDependencies(editor: KotlinEditor): KotlinScriptExternalDependencies? {
    if (!editor.isScript) {
        throw IllegalArgumentException("Script dependencies could not be obtained from non-script: $editor")
    }
