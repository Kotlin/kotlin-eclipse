...
public class AlignmentStrategy {
    ...
    private static final Set<String> BLOCK_ELEMENT_TYPES = new HashSet<String>(Arrays.asList("IF", "FOR", "WHILE", "FUN", "CLASS", "OBJECT_DECLARATION", "FUNCTION_LITERAL_EXPRESSION", "PROPERTY", "WHEN"));
