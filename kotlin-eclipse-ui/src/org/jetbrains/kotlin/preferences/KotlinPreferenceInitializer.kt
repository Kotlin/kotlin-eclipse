...
import org.jetbrains.kotlin.ui.editors.highlighting.initializePreferences

public class KotlinPreferenceInitializer : AbstractPreferenceInitializer() {
    override fun initializeDefaultPreferences() {
        val kotlinStore = Activator.getDefault().getPreferenceStore()
        initializePreferences(kotlinStore)
    }
}