...
public class VisualizationPage extends Dialog {

    private final Point pageSize = new Point(750, 650);
    private String sourceCode;
    private File file;
    
    private final String title = "Psi Context Viewer";
    
    public VisualizationPage(Shell parentShell) {
        super(parentShell);
    }
    ...
    private void setTreeViewer(Composite composite, final Text programText) {
        ...
        psiTreeViewer.setLabelProvider(new PsiLabelProvider());
