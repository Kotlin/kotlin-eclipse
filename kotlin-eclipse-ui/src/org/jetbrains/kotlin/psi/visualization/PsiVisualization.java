...
public class PsiVisualization extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        VisualizationPage page = new VisualizationPage(shell);
        page.setSourceCode(editor.getDocumentProvider().getDocument(HandlerUtil.getActiveEditorInput(event)).get());
        page.setFileToParse(file);
        page.open();
